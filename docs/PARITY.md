...
| other property functions: `bitrate:`,`orientation:`,`duration:`,`channels:`,`samplerate:`,… (and tags for Office/PDF) | ⛔ | need a broader per-format metadata index (large; see §9) |
