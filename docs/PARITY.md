...
| audio tags `artist:`,`album:`,`title:`,`year:`,`genre:`,`track:`,`comment:` | ➕ | dependency-free `AudioTags` reader — MP3 (ID3v2.3/2.4 + ID3v1), FLAC (Vorbis comments), and M4A/MP4 (iTunes atoms); matched as case-insensitive substrings |
| other property functions: `bitrate:`,`orientation:`,`duration:`,`channels:`,`samplerate:`,… (and tags for OGG/Office/PDF) | ⛔ | need a broader per-format metadata index (large; see §9) |
